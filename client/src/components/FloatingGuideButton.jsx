...
const styles = {
    ...
    // Inline workflow styles for modal context
    workflow: {
        display: 'flex',
        flexDirection: 'column',
        gap: 0
...
const workflowSteps = [
    ...
    },
    {
        ...
        color: '#94a3b8',
        branches: [
            { condition: 'Up to AED 500', result: 'Auto-approved by Head Engineer', color: '#22c55e' },
            { condition: 'Above AED 500', result: 'Routes to management for approval', color: '#3b82f6' }
        ]
    },
    {
...
function FloatingGuideButton() {
    const [isOpen, setIsOpen] = useState(false);
    const [isHovered, setIsHovered] = useState(false);

    // Inject keyframe animations
    useEffect(() => {
        const styleId = 'floating-guide-animations';
